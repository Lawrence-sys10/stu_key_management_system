...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('kiosk')->name('kiosk.')->middleware(['role:admin|security', 'kiosk'])->group(function () {
        ...
        // Add these to your web.php routes
Route::post('/keys/{key}/quick-checkin', [KioskController::class, 'quickCheckin'])->name('kiosk.quick-checkin');
Route::get('/keys/{key}/return-history', [KioskController::class, 'keyReturnHistory'])->name('kiosk.return-history');
Route::get('/analytics/return-statistics', [KioskController::class, 'returnStatistics'])->name('kiosk.return-statistics');
    });
    ...
    Route::prefix('keys')->name('keys.')->middleware(['role:admin|security|hr'])->group(function () {
        ...
        Route::get('scan/{uuid}', [KeyController::class, 'scan'])->name('scan');
